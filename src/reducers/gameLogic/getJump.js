...
const getJump = (color, checker, allCheckers, jumps) => {
  if (color === "Blue") {
    if (
      Math.floor((checker - 14) / 8) === Math.floor(checker / 8) - 2 &&
      (allCheckers[checker - 7] === "Black" ||
        allCheckers[checker - 7] === "Black King") &&
      allCheckers[checker - 14] === null
    ) {
      jumps.push({
        jumpTo: checker - 14,
        casualty: checker - 7,
    ...
    if (
      Math.floor((checker - 18) / 8) === Math.floor(checker / 8) - 2 &&
      (allCheckers[checker - 9] === "Black" ||
        allCheckers[checker - 9] === "Black King") &&
      allCheckers[checker - 18] === null
    ) {
      jumps.push({
        jumpTo: checker - 18,
        casualty: checker - 9,
  ...
  if (color === "Black") {
    if (
      Math.floor((checker + 14) / 8) === Math.floor(checker / 8) + 2 &&
      (allCheckers[checker + 7] === "Blue" ||
        allCheckers[checker + 7] === "Blue King") &&
      allCheckers[checker + 14] === null
    ) {
      jumps.push({
        jumpTo: checker + 14,
    ...
    if (
      Math.floor((checker + 18) / 8) === Math.floor(checker / 8) + 2 &&
      (allCheckers[checker + 9] === "Blue" ||
        allCheckers[checker + 9] === "Blue King") &&
      allCheckers[checker + 18] === null
    ) {
      jumps.push({
        jumpTo: checker + 18,
